...
async def load_recommender_model(user_id: int):
    ...
    -------
    str
        Результат загрузки модели: сообщение об успешной загрузке или об отсутствии пользователя в базе данных.
    """
...
async def load_win_predictor_model():
    ...
    -------
    str
        Результат загрузки модели: сообщение об успешной загрузке.
    """
    global CONFIG_PATH
